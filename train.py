...
def eval(cfg, model, dataloader, criterion, estimator, device):
    ...
    for test_data in dataloader:
        ...
        _, _ = estimator.update(y_pred, y)
        # true_ls.append(targets.tolist())
        # pred_ls.append(preds.tolist())
    with open('/home/ukjung18/pytorch-classification/data/y_score.pickle', 'wb') as f:
        pickle.dump(pred_ls, f)
    model.train()
